#!/bin/sh
curl -H 'Content-Type: application/json' -XDELETE 'localhost:29200/oldindex'
curl -H 'Content-Type: application/json' -XDELETE 'localhost:29200/newindex'

curl -X PUT "localhost:29200/oldindex"
curl -X PUT "localhost:29200/newindex"

curl -X PUT "localhost:29200/oldindex" -H 'Content-Type: application/json' -d'
{
  "mappings": {
    "_doc": {
      "properties": {
...
curl -X PUT "localhost:29200/newindex" -H 'Content-Type: application/json' -d'
{
  "mappings": {
    "_doc": {
      "properties": {
